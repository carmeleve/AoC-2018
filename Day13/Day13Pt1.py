...
def plus_condition(x, y , tracks):
    if tracks[(x+1,y)] == "-" and (tracks[(x,y+1)] == "|" or tracks[(x,y+1)] == "/" or tracks[(x,y+1)] == "\\" or tracks[(x,y+1)] == "+"):
        return True
...
while True:
    ...
    for cart in cart_directions:
        ...
        if track in cart_symbols:
            print(track)
            crash_coord = new_position

        elif track in direction_changes:
